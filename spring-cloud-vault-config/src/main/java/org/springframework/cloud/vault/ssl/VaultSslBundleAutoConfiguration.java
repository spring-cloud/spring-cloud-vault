...
public class VaultSslBundleAutoConfiguration {
	...
	@Bean
	CertificateRotationContainer certificateRotationContainer(TaskSchedulerWrapper taskSchedulerWrapper,
			CertificateAuthority certificateAuthority) {
		Lifecycle lifecycle = this.bundles.getLifecycle();
		CertificateRotationContainer container = new CertificateRotationContainer(
				taskSchedulerWrapper.getTaskScheduler(), certificateAuthority);
	...
	@Bean
	RotatingVaultSslBundleRegistrar vaultSslBundleRegistrar(ObjectProvider<VaultSslBundleRegistrar> registrars,
			CertificateRotationContainer certificateRotationContainer) {
		...
		return new RotatingVaultSslBundleRegistrar(certificateRotationContainer, vaultSslBundleRegistry);
	}
