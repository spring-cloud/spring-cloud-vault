...
/**
 * Secure store for {@link CertificateBundle} instances allowing storing private and
 * public keys.
 *
 * @author Mark Paluch
 * @since 5.1
...
public interface CertificateBundleStore {
	...
	/**
	 * Retrieve the {@link CertificateBundle} registered under the given {@code name}.
	 * Returns {@code null} if the bundle does not exist.
	 * @param name name of the certificate bundle.
	 * @return the certificate bundle or {@code null} if not found.
	 */
	@Nullable CertificateBundle getBundle(String name);
