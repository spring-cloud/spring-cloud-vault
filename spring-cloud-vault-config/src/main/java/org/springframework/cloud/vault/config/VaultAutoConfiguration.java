...
public class VaultAutoConfiguration {
	...
	public ClientFactoryWrapper clientHttpRequestFactoryWrapper() {
		...
		if (ClassUtils.isPresent("org.springframework.retry.support.RetryTemplate", getClass().getClassLoader())
				&& this.vaultProperties.isFailFast()) {
			clientHttpRequestFactory = this.configuration.createRetryableClientHttpRequestFactory();
		}
		else {
			clientHttpRequestFactory = this.configuration.createClientHttpRequestFactory();
		}
