...
/**
 * Versioned implementation of {@link CertificateBundleStore} using Vault's Key-Value (KV)
 * secret backend v2.
 *
 * @author Mark Paluch
 * @since 5.1
...
public class VersionedCertificateBundleStore implements CertificateBundleStore {
	 ...
	 * {@code backendPath}.
	 * <p>
	 * Certificate bundle names are used as-is as paths in the KV2 backend.
	 ...
	 * {@code backendPath}.
	 * <p>
	 * The Certificate bundle names are derived from the given {@code pathMapper} that is
	 * called with the bundle name and returns the secret path.
	 * @param operations the Vault operations.
	 * @param backendPath the kv2 backend mount path.
