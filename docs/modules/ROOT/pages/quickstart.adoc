...
NOTE: You do not need any of this to build Spring Cloud Vault itself.
The project's own tests start Vault with https://testcontainers.com[Testcontainers], so Docker is the only prerequisite.
